...
import { products } from "../../public/assets/js/assets";
    ...
    <section id="products" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-[#5a6268] max-w-5xl mx-auto">
            Discover our exquisite range of handcrafted floral arrangements and enchanting 3D Crystal Balls gifts. Each arrangement can be customized to create the perfect surprise for birthdays, anniversaries, weddings, or any special occasion in Cebu.</p>
        </div>
