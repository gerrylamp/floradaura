        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-[#f8f9fa]/80 text-sm mb-6">
              Creating moments of beauty and wonder through exquisite floral
              designs and crystal artistry.
            </p>
            <div className="flex space-x-4">
              {/* <a href="#" className="text-[#f8f9fa]/80 hover:text-[#d4af37] transition-colors">
                <InstagramIcon size={20} />
              </a> */}
              <a href="https://www.facebook.com/profile.php?id=61571762714156" className="text-[#f8f9fa]/80 hover:text-[#d4af37] transition-colors">
              ...
              <a href="https://www.tiktok.com/@blossom_bites8" target="_blank" rel="noopener noreferrer" className="text-[#f8f9fa]/80 hover:text-[#d4af37] transition-colors">
                <SiTiktok size={20} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <address className="not-italic text-[#f8f9fa]/80">
              ...
              <br />
              <a href='mailto: hello@floradaura.com'>hello@floradaura.com</a>
            </address>
          </div>
        </div>
